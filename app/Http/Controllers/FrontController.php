...
class FrontController extends Controller
{
    ...
    private function getStaticClients(): array
    {
        return [
            ...
            ['id' => 17, 'name' => 'Pupuk Indonesia',                 'logo_url' => asset('assets/img/client/logo-pupuk.png'),             'url' => null],
            ['id' => 18, 'name' => 'Pindo Deli',                      'logo_url' => asset('assets/img/client/logo_pindo_deli.svg'),        'url' => null],
            ['id' => 19, 'name' => 'Bagus Karya',                     'logo_url' => asset('assets/img/client/PT Bagus Karya.png'),         'url' => null],
            ['id' => 20, 'name' => 'Indo Sutech Sejahtera',           'logo_url' => asset('assets/img/client/pt_indo_sutech_sejahtera_logo.jfif'), 'url' => null],
        ];
    }
