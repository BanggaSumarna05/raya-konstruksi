...
class FrontController extends Controller
{
    ...
    private function getStaticClients(): array
    {
        return [
            ...
            ['id' => 11, 'name' => 'Pupuk Indonesia Logistik',           'logo_url' => asset('assets/img/client/logo-pupuk.png'),             'url' => null],
            ['id' => 12, 'name' => 'Pindo Deli',                         'logo_url' => asset('assets/img/client/logo_pindo_deli.svg'),        'url' => null],
            ['id' => 13, 'name' => 'Bagus Karya',                        'logo_url' => asset('assets/img/client/PT Bagus Karya.png'),         'url' => null],
            ['id' => 14, 'name' => 'ISS (Indo Sutech)',                  'logo_url' => asset('assets/img/client/pt_indo_sutech_sejahtera_logo.jfif'), 'url' => null],
